...
def get_few_shot_db_chain():
    ...
    db_password = ""
    db_host = "localhost"
    db_name = "chat-with-mysql-database"

    llm = GoogleGenerativeAI(model="models/text-bison-001", google_api_key="AIzaSyC_HTP7VKWvsbU3e-KTKt-dWU2Z0cF1G1M", temperature=0.1)
